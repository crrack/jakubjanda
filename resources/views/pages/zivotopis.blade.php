<div>
    ...
    <section class="px-6 pb-6 text-justify text-primary md:px-0">
        <div class="ml-2 lg:ml-auto content timeline-vertical">
          <div class="w-full pl-6 mb-4">
            <div class="md:flex md:flex-row-reverse">
              <div class="px-4 py-8 md:w-2/3 md:py-12">
                <p class="text-xl font-bold">Životní začátky</p>
              ...
              <img src="http://jakubjanda.cz/theme/img/zivotopis/1.png" alt="" class="mx-4 mt-4 md:w-1/3 md:h-full">
            </div>
          </div>
          <div class="w-full pl-6 mb-4">
            <div class="md:flex">
              <div class="px-4 py-8 md:w-2/3 md:py-12">
                <p class="text-xl font-bold">Start skokanské kariéry</p>
              ...
              <img src="http://jakubjanda.cz/theme/img/zivotopis/2.jpg" alt="" class="mx-4 mt-4 md:w-1/3 md:h-full">
            </div>
          </div>
          <div class="w-full pl-6 mb-4">
            <div class="md:flex md:flex-row-reverse">
              <div class="px-4 py-8 md:w-2/3">
                <p class="text-xl font-bold">Dokončení studia a první zkušenosti s velkými závody</p>
              ...
              <img src="http://jakubjanda.cz/theme/img/zivotopis/3.jpg" alt="" class="mx-4 mt-4 md:w-1/3 md:h-full">
            </div>
          </div>
          <div class="w-full pl-6 mb-4">
            <div class="md:flex">
              <div class="px-4 py-8 md:w-2/3 md:py-0">
                <p class="text-xl font-bold">Vítězství Světového poháru</p>
              ...
              <img src="http://jakubjanda.cz/theme/img/zivotopis/4.jpg" alt="" class="mx-4 mt-4 md:w-1/3 md:h-full">
            </div>
          </div>
          <div class="w-full pl-6 mb-4">
            <div class="md:flex md:flex-row-reverse">
              <div class="px-4 py-8 md:w-2/3 md:py-2">
                <p class="text-xl font-bold">Největší úspěchy v roli skokana na lyžích</p>
              ...
              <img src="http://jakubjanda.cz/theme/img/zivotopis/5.jpg" alt="" class="mx-4 mt-4 md:w-1/3 md:h-full">
            </div>
          </div>
          <div class="w-full pl-6 mb-4">
            <div class="md:flex">
              <div class="px-4 py-8 md:w-2/3">
                <p class="text-xl font-bold">Vstup do ODS</p>
              ...
              <img src="http://jakubjanda.cz/theme/img/zivotopis/6.jpg" alt="" class="mx-4 mt-4 md:w-1/3 md:h-full">
            </div>
          </div>
          <div class="w-full pl-6 mb-4">
            <div class="md:flex md:flex-row-reverse">
              <div class="px-4 py-8 md:w-2/3 md:py-2">
                <p class="text-xl font-bold">Regionální podpora sportu? No jasně!</p>
      ...
      Věnuji se podpoře sportu i na regionální úrovni. V městské radě ve Frenštátě p. R. jsem byl členem Sportovní komise (2010-2018) a od roku 2012 působím ve Výboru pro tělovýchovu a sport Zastupitelstva Moravskoslezského kraje.
              ...
              <img src="http://jakubjanda.cz/theme/img/zivotopis/7.jpg" alt="" class="mx-4 mt-4 md:w-1/3 md:h-full">
            </div>
          </div>
          <div class="w-full pl-6 mb-4">
            <div class="md:flex">
              <div class="px-4 py-8 md:w-2/3 md:py-12">
                <p class="text-xl font-bold">Zvolen poslancem</p>
              ...
              <img src="http://jakubjanda.cz/theme/img/zivotopis/8.jpg" alt="" class="mx-4 mt-4 md:w-1/3 md:h-full">
            </div>
          </div>
          <div class="w-full pl-6 mb-4">
            <div class="md:flex md:flex-row-reverse">
              <div class="px-4 py-8 md:w-2/3 md:py-12">
                <p class="text-xl font-bold">Rodina, moje největší podpora</p>
              ...
              <img src="http://jakubjanda.cz/theme/img/zivotopis/9.jpg" alt="" class="mx-4 mt-4 md:w-1/3 md:h-full">
            </div>
          </div>
          <div class="w-full pl-6 mb-4">
            <div class="md:flex">
              <div class="px-4 py-8 md:w-2/3 md:py-12">
                <p class="text-xl font-bold">Na sport nezapomínám</p>
              ...
              <img src="http://jakubjanda.cz/theme/img/zivotopis/10.jpg" alt="" class="mx-4 mt-4 md:w-1/3 md:h-full">
            </div>
          </div>
        </div>
      </section>
