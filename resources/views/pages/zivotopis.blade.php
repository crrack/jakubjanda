<div>
    ...
    <section class="px-6 pb-6 text-justify text-primary md:px-0">
        <div class="ml-2 lg:ml-auto content timeline-vertical">
          <div class="w-full pl-6 mb-4">
            <div class="md:flex md:flex-row-reverse">
              ...
              <img src="./img/zivotopis/1.png" alt="" class="mx-4 mt-4 md:w-1/3 md:h-full">
            </div>
          </div>
          <div class="w-full pl-6 mb-4">
            <div class="md:flex">
              ...
              <img src="./img/zivotopis/2.jpg" alt="" class="mx-4 mt-4 md:w-1/3 md:h-full">
            </div>
          </div>
          <div class="w-full pl-6 mb-4">
            <div class="md:flex md:flex-row-reverse">
              ...
              <img src="./img/zivotopis/3.jpg" alt="" class="mx-4 mt-4 md:w-1/3 md:h-full">
            </div>
          </div>
          <div class="w-full pl-6 mb-4">
            <div class="md:flex">
              ...
              <img src="./img/zivotopis/4.jpg" alt="" class="mx-4 mt-4 md:w-1/3 md:h-full">
            </div>
          </div>
          <div class="w-full pl-6 mb-4">
            <div class="md:flex md:flex-row-reverse">
              ...
              <img src="./img/zivotopis/5.jpg" alt="" class="mx-4 mt-4 md:w-1/3 md:h-full">
            </div>
          </div>
          <div class="w-full pl-6 mb-4">
            <div class="md:flex">
              ...
              <img src="./img/zivotopis/6.jpg" alt="" class="mx-4 mt-4 md:w-1/3 md:h-full">
            </div>
          </div>
          <div class="w-full pl-6 mb-4">
            <div class="md:flex md:flex-row-reverse">
      ...
      Věnuji se podpoře sportu i na regionální úrovni. V městské radě ve Frenštátě p. R. jsem byl členem Sportovní komise (2010-2018) a od roku 2012 působím ve Výboru pro tělovýchovu a sport Zastupitelstva Moravskoslezského kraje.
              ...
              <img src="./img/zivotopis/7.jpg" alt="" class="mx-4 mt-4 md:w-1/3 md:h-full">
            </div>
          </div>
          <div class="w-full pl-6 mb-4">
            <div class="md:flex">
              ...
              <img src="./img/zivotopis/8.jpg" alt="" class="mx-4 mt-4 md:w-1/3 md:h-full">
            </div>
          </div>
          <div class="w-full pl-6 mb-4">
            <div class="md:flex md:flex-row-reverse">
              ...
              <img src="./img/zivotopis/9.jpg" alt="" class="mx-4 mt-4 md:w-1/3 md:h-full">
            </div>
          </div>
          <div class="w-full pl-6 mb-4">
            <div class="md:flex">
              ...
              <img src="./img/zivotopis/10.jpg" alt="" class="mx-4 mt-4 md:w-1/3 md:h-full">
            </div>
          </div>
        </div>
      </section>
